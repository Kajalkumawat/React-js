...
function App() {
  ...
  return (
    <>
     <h1 className='bg-green-400 text-black p-4 rounded-xl'>Radio Page</h1>
  ...
  <div class="flex items-center space-x-4">
    <img src="https://images.pexels.com/photos/3783471/pexels-photo-3783471.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" width="88" height="88" class="flex-none rounded-lg bg-slate-100" loading="lazy" />
